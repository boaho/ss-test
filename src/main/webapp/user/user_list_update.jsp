...
%>			  
			  ...
			  <tr>
			    ...
			    <td><%= uemail %></td>
			    <td>
<a href="<%= request.getContextPath() %>/user/user_update_form.jsp?uid=<%= uid %>&upw=<%= upw %>&uname=<%= uname %>&uphone=<%= uphone %>&uemail=<%= uemail %>">수정클릭</a>
			    </td>
			    <td>
<a href="<%= request.getContextPath() %>/user/user_list_delete.jsp">삭제클릭</a>			    
			    </td>
			  </tr>
			</table>		       
